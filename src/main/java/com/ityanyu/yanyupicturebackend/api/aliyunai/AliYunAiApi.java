package com.ityanyu.yanyupicturebackend.api.aliyunai;
...
public class AliYunAiApi {
    ...
    public GetOutPaintingTaskResponse getOutPaintingTask(String taskId) {
        ...
        String getUrl = String.format(GET_OUT_PAINTING_TASK_URL, taskId);
        try (HttpResponse httpResponse = HttpRequest.get(getUrl)
                .header(Header.AUTHORIZATION, "Bearer " + apiKey)
                .execute()) {
            if (!httpResponse.isOk()) {
